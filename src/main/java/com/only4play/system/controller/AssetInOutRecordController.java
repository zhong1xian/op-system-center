...
public class AssetInOutRecordController {
   ...
   * createRequest
   */
  @PostMapping("createAssetInOutRecord")
  public JsonObject<Long> createAssetInOutRecord(
      @RequestBody AssetInOutRecordCreateRequest request) {
    AssetInOutRecordCreator creator = AssetInOutRecordMapper.INSTANCE.request2Dto(request);
    return JsonObject.success(assetInOutRecordService.createAssetInOutRecord(creator));
  }

  /**
   * update request
   */
  @PostMapping("updateAssetInOutRecord")
  public JsonObject<String> updateAssetInOutRecord(
      @RequestBody AssetInOutRecordUpdateRequest request) {
    AssetInOutRecordUpdater updater = AssetInOutRecordMapper.INSTANCE.request2Updater(request);
    assetInOutRecordService.updateAssetInOutRecord(updater);
  ...
  public JsonObject<String> validAssetInOutRecord(@PathVariable Long id) {
    assetInOutRecordService.validAssetInOutRecord(id);
    return JsonObject.success(CodeEnum.Success.getName());
  }
  ...
  public JsonObject<String> invalidAssetInOutRecord(@PathVariable Long id) {
    assetInOutRecordService.invalidAssetInOutRecord(id);
    return JsonObject.success(CodeEnum.Success.getName());
  }
